package com.moss.spring.boot.autoconfigure.stream.idoc;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.moss.spring.boot.stream.idoc.domain.RuleProperties;
...
import com.moss.spring.boot.stream.idoc.listener.IdocListenerCustomizer;
import com.moss.spring.boot.stream.idoc.listener.IdocListenerSupport;
import com.moss.spring.boot.stream.idoc.service.base.DefaultIdocMessageConverter;
import com.moss.spring.boot.stream.idoc.service.base.IBaseExecService;
import com.moss.spring.boot.stream.idoc.service.base.IBaseTaskService;
import com.moss.spring.boot.stream.idoc.service.base.IdocMessageConverter;
import com.moss.spring.boot.stream.idoc.strategy.HandlerContext;
